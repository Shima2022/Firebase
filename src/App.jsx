...
function App() {
  ...
  const fetchItems = () => {
    fetch('https://bookstore-86515-default-rtdb.europe-west1.firebasedatabase.app/books/.json')
  ...
  const deleteBook = (id) => {
    fetch(`https://bookstore-86515-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`, {
      method: 'DELETE',
    })
      .then((response) => fetchItems())
      .catch((err) => console.error(err));
